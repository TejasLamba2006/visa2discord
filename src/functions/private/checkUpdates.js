...
module.exports = async () => {
    ...
    // @ts-ignore
    const packageData = await require('node-fetch')(`https://registry.npmjs.com/visa2discord`).then(text => text.json()).catch(() => {
        return;
    });
    // @ts-ignore
    ...
    const change = `${require('../../../package.json').version} --> ${packageData['dist-tags'].latest}`
        console.log('\n\n')
        console.log('\x1b[32m' + '-------------------------------------------------------')
        console.log('\x1b[32m' + '| visa2discord                                 - [] X |')
        console.log('\x1b[32m' + '-------------------------------------------------------')
        ...
        console.log('\x1b[31m' + `| https://github.com/The-Rainbow-Studios/visa2discord/releases/tag/${packageData['dist-tags'].latest}|`)
