module.exports = function splitMessageRegex(text, {
    maxLength = 2_000,
    regex = /\n/g,
    prepend = '',
    append = '',
    ...
    function addChunk(chunkEndIndex, nextDelim) {
      ...
      if (prepend.length + nextChunkLen + append.length > maxLength) {
        throw new RangeError('[visa2discord] A single message part exceeded the length limit. This should never happen. Please report this to the developer on GitHub:');
      }
